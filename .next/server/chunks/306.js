((exports.id = 306),
  ...
  (exports.modules = {
    ...
    9959: (a, b, c) => {
      'use strict';
      a.exports = c(55022).vendored['react-rsc'].React;
    },
    9988: (a, b) => {
      'use strict';
      (Object.defineProperty(b, '__esModule', { value: !0 }),
    ...
    89867: (a, b, c) => {
      ...
      (c.r(b),
        c.d(b, {
          ...
          DiagLogLevel: () => d,
          INVALID_SPANID: () => K,
          INVALID_SPAN_CONTEXT: () => M,
          INVALID_TRACEID: () => L,
          ProxyTracer: () => ab,
          ProxyTracerProvider: () => ad,
          ROOT_CONTEXT: () => D,
          SamplingDecision: () => f,
          SpanKind: () => g,
          SpanStatusCode: () => h,
          ...
          createContextKey: () => C,
          default: () => as,
          defaultTextMapGetter: () => A,
          defaultTextMapSetter: () => B,
          diag: () => ar,
          isSpanContextValid: () => Y,
          isValidSpanId: () => X,
          isValidTraceId: () => W,
          propagation: () => aq,
          trace: () => ap,
      ...
      var d,
        ...
        g,
        h,
        i = 'object' == typeof globalThis ? globalThis : global,
        j = '1.0.4',
        k = /^(\d+)\.(\d+)\.(\d+)(-(.+))?$/,
        l = (function (a) {
          var b = new Set([a]),
        ...
        m = Symbol.for('opentelemetry.js.api.' + j.split('.')[0]);
      function n(a, b, c, d) {
        void 0 === d && (d = !1);
        var e,
          f = (i[m] = null != (e = i[m]) ? e : { version: j });
        if (!d && f[a]) {
          var g = Error(
            '@opentelemetry/api: Attempted duplicate registration of API: ' + a,
          );
        ...
        return (
          (f[a] = b),
          c.debug(
            '@opentelemetry/api: Registered a global for ' + a + ' v' + j + '.',
          ),
          !0
        );
      }
      function o(a) {
        var b,
          c,
          d = null == (b = i[m]) ? void 0 : b.version;
        if (d && l(d)) return null == (c = i[m]) ? void 0 : c[a];
      }
      function p(a, b) {
        b.debug(
        ...
        return (
          (a.prototype.debug = function () {
            for (var a = [], b = 0; b < arguments.length; b++)
              a[b] = arguments[b];
            return r('debug', this._namespace, a);
          }),
          (a.prototype.error = function () {
            for (var a = [], b = 0; b < arguments.length; b++)
              a[b] = arguments[b];
            return r('error', this._namespace, a);
          }),
          (a.prototype.info = function () {
            for (var a = [], b = 0; b < arguments.length; b++)
              a[b] = arguments[b];
            return r('info', this._namespace, a);
          }),
          (a.prototype.warn = function () {
            for (var a = [], b = 0; b < arguments.length; b++)
              a[b] = arguments[b];
            return r('warn', this._namespace, a);
          }),
          (a.prototype.verbose = function () {
            for (var a = [], b = 0; b < arguments.length; b++)
              a[b] = arguments[b];
            return r('verbose', this._namespace, a);
          }),
          a
        );
      })();
      function r(a, b, c) {
        var d = o('diag');
        if (d) return (c.unshift(b), d[a].apply(d, c));
      }
      !(function (a) {
        ((a[(a.NONE = 0)] = 'NONE'),
          (a[(a.ERROR = 30)] = 'ERROR'),
      ...
      var s = (function () {
            ...
            function a(a) {
              return function () {
                for (var b = [], c = 0; c < arguments.length; c++)
                  b[c] = arguments[c];
                var d = o('diag');
                if (d) return d[a].apply(d, b);
              };
            }
            var b = this;
            ((b.setLogger = function (a, c) {
              if ((void 0 === c && (c = d.INFO), a === b)) {
                var e,
                  f,
                  g = Error(
                    'Cannot use diag as the logger for itself. Please use a DiagLogger implementation like ConsoleDiagLogger or a custom implementation',
                  );
                return (b.error(null != (e = g.stack) ? e : g.message), !1);
              }
              var h = o('diag'),
                i = (function (a, b) {
                  function c(c, d) {
              ...
              if (h) {
                var j =
                  null != (f = Error().stack)
                    ? f
                    : '<failed to generate stacktrace>';
                (h.warn('Current logger will be overwritten from ' + j),
                  i.warn(
        ...
        t = (function () {
          ...
          return (
            ...
            (a.prototype.removeEntries = function () {
              for (var b = [], c = 0; c < arguments.length; c++)
                b[c] = arguments[c];
              for (var d = new a(this._entries), e = 0; e < b.length; e++) {
                var f = b[e];
                d._entries.delete(f);
              }
              return d;
        ...
        u = Symbol('BaggageEntryMetadata'),
        v = s.instance();
      function w(a) {
        return (void 0 === a && (a = {}), new t(new Map(Object.entries(a))));
      }
      function x(a) {
        return (
          'string' != typeof a &&
      ...
      var D = new (function a(b) {
        ...
        E = function (a, b) {
          for (var c = 0, d = b.length, e = a.length; c < d; c++, e++)
            a[e] = b[c];
          return a;
        },
        F = (function () {
        ...
        J = (function () {
          ...
          return (
            ...
            (a.prototype.disable = function () {
              (this._getContextManager().disable(), p(H, s.instance()));
            }),
            a
          );
        })();
      ...
      var K = '0000000000000000',
        ...
        M = { traceId: L, spanId: K, traceFlags: e.NONE },
        N = (function () {
          function a(a) {
            (void 0 === a && (a = M), (this._spanContext = a));
          }
          return (
        ...
        O = C('OpenTelemetry Context Key SPAN');
      function P(a) {
        return a.getValue(O) || void 0;
      }
      function Q(a, b) {
        return a.setValue(O, b);
      }
      function R(a) {
        return a.deleteValue(O);
      }
      function S(a, b) {
        return Q(a, new N(b));
      }
      function T(a) {
        var b;
        return null == (b = P(a)) ? void 0 : b.spanContext();
      }
      var U = /^([0-9a-f]{32})$/i,
        V = /^[0-9a-f]{16}$/i;
      function W(a) {
      ...
      var $ = J.getInstance(),
        _ = (function () {
          ...
          return (
            (a.prototype.startSpan = function (a, b, c) {
              if (null == b ? void 0 : b.root) return new N();
              var d,
                e = c && T(c);
        ...
        ab = (function () {
          function a(a, b, c) {
            ((this._provider = a), (this.name = b), (this.version = c));
          }
          return (
            (a.prototype.startSpan = function (a, b, c) {
              return this._getTracer().startSpan(a, b, c);
            ...
            (a.prototype._getTracer = function () {
              if (this._delegate) return this._delegate;
              var a = this._provider.getDelegateTracer(this.name, this.version);
              return a ? ((this._delegate = a), this._delegate) : aa;
            }),
            a
          );
        })(),
        ...
        ad = (function () {
          ...
          return (
            (a.prototype.getTracer = function (a, b) {
              var c;
              return null != (c = this.getDelegateTracer(a, b))
                ? c
                : new ab(this, a, b);
            }),
            (a.prototype.getDelegate = function () {
              var a;
              return null != (a = this._delegate) ? a : ac;
            }),
            (a.prototype.setDelegate = function (a) {
              this._delegate = a;
            }),
            (a.prototype.getDelegateTracer = function (a, b) {
              var c;
              return null == (c = this._delegate) ? void 0 : c.getTracer(a, b);
            }),
            a
          );
        })();
      ...
      var ae = 'trace',
        af = (function () {
          function a() {
            ((this._proxyTracerProvider = new ad()),
              (this.wrapSpanContext = Z),
              (this.isSpanContextValid = Y),
              (this.deleteSpan = R),
              (this.getSpan = P),
              (this.getSpanContext = T),
              (this.setSpan = Q),
              (this.setSpanContext = S));
          }
          return (
            (a.getInstance = function () {
              return (
            ...
            (a.prototype.setGlobalTracerProvider = function (a) {
              var b = n(ae, this._proxyTracerProvider, s.instance());
              return (b && this._proxyTracerProvider.setDelegate(a), b);
            }),
            (a.prototype.getTracerProvider = function () {
              return o(ae) || this._proxyTracerProvider;
            }),
            (a.prototype.getTracer = function (a, b) {
              return this.getTracerProvider().getTracer(a, b);
            }),
            (a.prototype.disable = function () {
              (p(ae, s.instance()), (this._proxyTracerProvider = new ad()));
            }),
            a
          );
        })(),
        ...
        ah = C('OpenTelemetry Baggage Key');
      function ai(a) {
      ...
      var al = 'propagation',
        ...
        aq = an.getInstance(),
        ar = s.instance();
      let as = { trace: ap, context: ao, propagation: aq, diag: ar };
    },
    90364: (a, b) => {
      'use strict';
      (Object.defineProperty(b, '__esModule', { value: !0 }),
