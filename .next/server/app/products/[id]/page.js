(() => {
  ...
  ((a.id = 403),
    ...
    (a.modules = {
      ...
      4264: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 52254));
      },
      10846: (a) => {
        'use strict';
      ...
      17416: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 93776));
      },
      17672: (a) => {
        a.exports = {
                    ...
                    children: [
                      '[id]',
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(c.bind(c, 43331)),
                              '/Users/baaasil/Dev/Basil-portfolio/myshop-web/app/products/[id]/page.tsx',
                            ],
                          },
                        ],
                      },
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      43331: (a, b, c) => {
        ...
        async function f({ params: a }) {
          let { id: b } = await a,
            c = await fetch(`http://localhost:3001/products/${b}`, {
              cache: 'no-store',
            });
          if (!c.ok)
            return (0, d.jsx)('p', {
          ...
          return (0, d.jsxs)('main', {
            ...
            children: [
              ...
              (0, d.jsx)(e.default, { id: f.id, name: f.name, price: f.price }),
            ],
          });
        }
      },
      ...
      93776: (a, b, c) => {
        ...
        let d = (0, c(1646).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/Users/baaasil/Dev/Basil-portfolio/myshop-web/app/products/[id]/AddToCart.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.',
            );
          },
  ...
  b.C(a);
  var c = b.X(0, [306, 73], () => b((b.s = 27015)));
  module.exports = c;
})();
