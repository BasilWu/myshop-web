    ...
    (a.modules = {
      ...
      33373: (a, b, c) => {
        ...
        var d = c(12076),
          ...
          g = c.n(f);
        function h() {
          let { items: a, total: b, remove: c, clear: f } = (0, e._)();
      ...
      41228: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 33373));
      },
      53959: (a, b, c) => {
        'use strict';
        ...
        let d = (0, c(1646).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/Users/baaasil/Dev/Basil-portfolio/myshop-web/app/cart/page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.',
            );
          },
                ...
                children: [
                  'cart',
                  {
                    children: [
                      ...
                      {
                        page: [
                          () => Promise.resolve().then(c.bind(c, 53959)),
                          '/Users/baaasil/Dev/Basil-portfolio/myshop-web/app/cart/page.tsx',
                        ],
                      },
                    ],
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
  ...
  b.C(a);
  var c = b.X(0, [306, 73], () => b((b.s = 68885)));
  module.exports = c;
})();
